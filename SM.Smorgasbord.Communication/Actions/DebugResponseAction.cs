...
{
   public class DebugResponseAction:ActionBase
    {
       public DebugResponseAction(DataBus bus)
            : base("execute", bus)
        {
            IsGzip = true;
       ...
       {
           string xmlData = "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header></SOAP-ENV:Header><SOAP-ENV:Body><execute><thread>" + ThreadId + "</thread><debugResponse></debugResponse></execute></SOAP-ENV:Body></SOAP-ENV:Envelope>";
